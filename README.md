...
| **图片下载** | 自动识别消息中的图片并下载保存到本地，与消息记录一并归档 |
...
| 项目Alpha客户群 | 李四 | 2025/06/01 14:35:07 | [图片] → 本地路径 images/20250601_143507.png |

图片消息会自动下载并保存到 Excel 同级目录的 `images/` 文件夹，表格中记录对应本地路径，离线也能查阅。
...
**支持哪些消息类型？** 目前支持文字消息和图片消息（图片自动下载到本地）；文件/语音等类型后续扩展。
